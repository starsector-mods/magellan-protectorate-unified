...
// below is mostly a copy of the vanilla DroneStrikeStats script

public class DroneStrikeLevellerStats extends BaseShipSystemScript implements DroneStrikeStatsAIInfoProvider {
	...
	protected String getWeaponId() {
		return "magellan_swarmfighter_missile";
	}
	...
	protected ShipAPI findTarget(ShipAPI ship) {
		...
		// was set with R, so, respect that
	...
	public boolean isUsable(ShipSystemAPI system, ShipAPI ship) {
		if (ship != null && ship.getSystem() != null && ship.getSystem().getState() != SystemState.IDLE) {
			// preventing out-of-ammo click when launching last drone
			return true;
		}
	...
	public int getMaxDrones() {	return 6;}
