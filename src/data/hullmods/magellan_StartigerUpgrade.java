...
extends BaseHullMod {
    ...
    public void addPostDescriptionSection(TooltipMakerAPI tooltip, ShipAPI.HullSize hullSize, ShipAPI ship, float width, boolean isForModSpec) {
        ...
        tooltip.addPara("- " + this.getString("EngDesc4"), 2.0f, h, new String[]{"10%"});
        LabelAPI label = tooltip.addPara("\u2014\u2014\u2014 " + this.getString("StartigerModTitle") + " \u2014\u2014\u2014", mag, 4.0f);
        label.setAlignment(Alignment.MID);
        tooltip.addPara("- " + this.getString("StartigerModDesc5"), 4.0f, h, new String[]{"25%"});
        LabelAPI intlabel = tooltip.addPara("- " + this.getString("StartigerModDesc6"), 2.0f, h, new String[]{"25%"});
