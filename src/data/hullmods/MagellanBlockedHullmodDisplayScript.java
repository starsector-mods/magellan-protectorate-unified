...
implements EveryFrameScript {
    ...
    private static java.lang.ref.WeakReference<ShipAPI> shipRef = null;
    ...
    public static void showBlocked(ShipAPI blocked) {
        ...
        shipRef = new java.lang.ref.WeakReference<>(blocked);
        blocked.getVariant().addMod(NOTIFICATION_HULLMOD);
