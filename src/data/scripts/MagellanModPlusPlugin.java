...
public class MagellanModPlusPlugin extends BaseModPlugin {
	...
	public void setupLogisticsNetwork() {
		SectorAPI sector = Global.getSector();
		if (sector == null) return;
		if (!sector.hasScript(data.scripts.magellan_LogisticsNetworkScript.class)) {
			sector.addScript(new data.scripts.magellan_LogisticsNetworkScript());
		}
	}
}
