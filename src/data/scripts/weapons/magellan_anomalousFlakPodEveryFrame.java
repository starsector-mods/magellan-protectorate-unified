...
public class magellan_anomalousFlakPodEveryFrame implements OnFireEffectPlugin, EveryFrameWeaponEffectPlugin {
    public static final String RIFT_WPN_ID = "magellan_anomalous_flakpod_rift";
    public static final String BOSS_RIFT_WPN_ID = "magellan_anomalous_flakpod_rift_boss";
    ...
    public void onFire(DamagingProjectileAPI proj, WeaponAPI weapon, CombatEngineAPI engine) {
        ...
        float redline = effectOverlevel - 1f;
