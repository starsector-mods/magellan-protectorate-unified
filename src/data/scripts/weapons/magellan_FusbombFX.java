...
public class magellan_FusbombFX
...
EveryFrameWeaponEffectPlugin {
    ...
    public void advance(float amount, CombatEngineAPI engine, WeaponAPI weapon) {
        ...
        if (weapon.isFiring()) {
            ...
            ShipAPI ship = weapon.getShip();
            this.elapsed += amount;
            Vector2f particle_offset = MagellanUtils.translate_polar(weapon_location, 2.0f, weapon.getCurrAngle());
            ...
            for (int x = 0; x < particle_count_this_frame; ++x) {
                ...
                float speed = MagellanUtils.get_random(50.0f, 150.0f);
                float angle = weapon.getCurrAngle() + MagellanUtils.get_random(-5.0f, 5.0f);
