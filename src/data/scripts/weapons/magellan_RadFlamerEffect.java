...
public class magellan_RadFlamerEffect
extends BaseCombatLayeredRenderingPlugin
implements OnFireEffectPlugin,
OnHitEffectPlugin,
EveryFrameWeaponEffectPlugin {
    protected List<magellan_RadFlamerEffect> trails;
    ...
    public magellan_RadFlamerEffect() {
    }
    ...
    public void advance(float amount, CombatEngineAPI engine, WeaponAPI weapon) {
        ...
        Iterator<magellan_RadFlamerEffect> iter = this.trails.iterator();
        while (iter.hasNext()) {
        ...
        if (weapon.getShip() != null) {
            ...
            for (magellan_RadFlamerEffect curr : this.trails) {
        ...
        int i = 0;
        while ((float)i < 1.0f) {
            for (magellan_RadFlamerEffect trail : this.trails) {
                float dist1;
    ...
    public void onFire(DamagingProjectileAPI projectile, WeaponAPI weapon, CombatEngineAPI engine) {
        ...
        magellan_RadFlamerEffect trail = new magellan_RadFlamerEffect(projectile, prev);
        ...
        if (this.trails == null) {
            this.trails = new ArrayList<magellan_RadFlamerEffect>();
        }
        this.trails.add(0, trail);
    }

    public magellan_RadFlamerEffect(DamagingProjectileAPI proj, DamagingProjectileAPI prev) {
        this.proj = proj;
        this.prev = prev;
