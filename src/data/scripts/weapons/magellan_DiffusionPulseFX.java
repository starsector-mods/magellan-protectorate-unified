...
public class magellan_DiffusionPulseFX
...
EveryFrameWeaponEffectPlugin {
    ...
    public void advance(float amount, CombatEngineAPI engine, WeaponAPI weapon) {
        ...
        if (weapon.isFiring()) {
            ...
            ShipAPI ship = weapon.getShip();
            this.elapsed += amount;
            Vector2f particle_offset = MagellanUtils.translate_polar(weapon_location, 5.0f, weapon.getCurrAngle());
            ...
            for (int x = 0; x < particle_count_this_frame; ++x) {
                ...
                float speed = MagellanUtils.get_random(75.0f, 125.0f);
